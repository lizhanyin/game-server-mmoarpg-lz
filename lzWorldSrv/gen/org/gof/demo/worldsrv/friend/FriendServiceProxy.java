...
public final class FriendServiceProxy extends ProxyBase {
    ...
    public void addFriend(String friendListStr, List humanIds) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_FRIEND_FRIENDSERVICE_ADDFRIEND_STRING_LIST,
                new Object[] { friendListStr, humanIds });
    }

    public void refuseFriend(String applyListStr, long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_FRIEND_FRIENDSERVICE_REFUSEFRIEND_STRING_LONG,
                new Object[] { applyListStr, humanId });
    }

    public void removeBlackList(String blackListStr, long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_FRIEND_FRIENDSERVICE_REMOVEBLACKLIST_STRING_LONG,
                new Object[] { blackListStr, humanId });
    }

    public void removeFriend(String friendListStr, long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_FRIEND_FRIENDSERVICE_REMOVEFRIEND_STRING_LONG,
                new Object[] { friendListStr, humanId });
    }

    public void toBlackList(String blackListStr, long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_FRIEND_FRIENDSERVICE_TOBLACKLIST_STRING_LONG,
                new Object[] { blackListStr, humanId });
    }
}
