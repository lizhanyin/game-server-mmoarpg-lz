...
public final class HumanGlobalServiceProxy extends ProxyBase {
    ...
    public void ChangeConnPoint(Long id, CallPoint point) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_CHANGECONNPOINT_LONG_CALLPOINT,
                new Object[] { id, point });
    }

    public void cancel(long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_CANCEL_LONG,
                new Object[] { humanId });
    }

    public void getInfo(List humansIds) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_GETINFO_LIST,
                new Object[] { humansIds });
    }

    public void getInfo(long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_GETINFO_LONG,
                new Object[] { humanId });
    }

    public void getInfos(List humanIds) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_GETINFOS_LIST,
                new Object[] { humanIds });
    }

    public void getInfosByMap(Map humanIdsMap) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_GETINFOSBYMAP_MAP,
                new Object[] { humanIdsMap });
    }

    public void getRecommendUsers(long humanId, String friendListStr, String blackListStr, int combat) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_GETRECOMMENDUSERS_LONG_STRING_STRING_INT,
                new Object[] { humanId, friendListStr, blackListStr, combat });
    }

    public void isLogined(String account) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_ISLOGINED_STRING,
                new Object[] { account });
    }

    public void kick(long id, String reason) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_KICK_LONG_STRING,
                new Object[] { id, reason });
    }

    public void register(HumanGlobalInfo status) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_REGISTER_HUMANGLOBALINFO,
                new Object[] { status });
    }

    public void sendInform(HumanScopeKey type, List keys, int channel, String content, Long sendHumanId) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_SENDINFORM_HUMANSCOPEKEY_LIST_INT_STRING_LONG,
                new Object[] { type, keys, channel, content, sendHumanId });
    }

    public void sendMsg(long humanId, Message msg) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_SENDMSG_LONG_MESSAGE,
                new Object[] { humanId, msg });
    }

    public void sendMsgToAll(List excludeIds, Message msg) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_SENDMSGTOALL_LIST_MESSAGE,
                new Object[] { excludeIds, msg });
    }

    public void stageIdModify(long humanId, long stageIdNew, String stageName, String nodeId, String portId) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_HUMAN_HUMANGLOBALSERVICE_STAGEIDMODIFY_LONG_LONG_STRING_STRING_STRING,
                new Object[] { humanId, stageIdNew, stageName, nodeId, portId });
    }
}
