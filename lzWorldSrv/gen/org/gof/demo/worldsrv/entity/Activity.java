...
@GofGenFile
public final class Activity extends EntityBase {
    public static final String tableName = "demo_activity";
    ...
    public static final class K {
        ...
        public static final String signInJson = "signInJson";    //签到相关{count:count,time:time,state:state}
        public static final String lineLoginJson = "lineLoginJson";    //连续登陆相关{count:count,time:time}
        public static final String addLoginJson = "addLoginJson";    //累计登陆相关{count:count,time:time}
    }
    ...
    */
    ...
    /**
     * 签到相关{count:count,time:time,state:state}
     */
    public String getSignInJson() {
        return record.get("signInJson");
    }

    public void setSignInJson(final String signInJson) {
        //更新前的数据状态
        int statusOld = record.getStatus();
        
        //更新属性
        record.set("signInJson", signInJson);
    ...
    */
    @Deprecated
    public void setNoChangeSignInJson(final String signInJson) {
        //更新属性
        record.setNoUpdate("signInJson", signInJson);
    }
    /**
     * 连续登陆相关{count:count,time:time}
     */
    public String getLineLoginJson() {
        return record.get("lineLoginJson");
    }

    public void setLineLoginJson(final String lineLoginJson) {
        //更新前的数据状态
        int statusOld = record.getStatus();
        
        //更新属性
        record.set("lineLoginJson", lineLoginJson);
    ...
    */
    @Deprecated
    public void setNoChangeLineLoginJson(final String lineLoginJson) {
        //更新属性
        record.setNoUpdate("lineLoginJson", lineLoginJson);
    }
    /**
     * 累计登陆相关{count:count,time:time}
     */
    public String getAddLoginJson() {
        return record.get("addLoginJson");
    }

    public void setAddLoginJson(final String addLoginJson) {
        //更新前的数据状态
        int statusOld = record.getStatus();
        
        //更新属性
        record.set("addLoginJson", addLoginJson);
    ...
    */
    @Deprecated
    public void setNoChangeAddLoginJson(final String addLoginJson) {
        //更新属性
        record.setNoUpdate("addLoginJson", addLoginJson);
    }
