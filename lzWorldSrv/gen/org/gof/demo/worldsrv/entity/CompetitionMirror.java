...
@GofGenFile
public final class CompetitionMirror extends EntityBase {
    public static final String tableName = "demo_competition_mirror";
    ...
    public CompetitionMirror(Record record) {
        super(record);
    }
