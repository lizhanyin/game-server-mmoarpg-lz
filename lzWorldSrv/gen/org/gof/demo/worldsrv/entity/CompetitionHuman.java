...
@GofGenFile
public final class CompetitionHuman extends EntityBase {
    public static final String tableName = "demo_competition_human";
    ...
    public static final class K {
        ...
        public static final String rank = "rank";    //玩家当前排名
        public static final String rankDaily = "rankDaily";    //每日结算时的排名
        public static final String awardTime = "awardTime";    //发奖的时间
        public static final String isRobot = "isRobot";    //是否是机器人
    }
    ...
    public CompetitionHuman() {
        super();
    }

    public CompetitionHuman(Record record) {
        super(record);
    }
    ...
    */
    @Deprecated
    public void setNoChangeRankDaily(final int rankDaily) {
        //更新属性
        record.setNoUpdate("rankDaily", rankDaily);
    }
    /**
     * 发奖的时间
     */
    public long getAwardTime() {
        return record.get("awardTime");
    }

    public void setAwardTime(final long awardTime) {
        //更新前的数据状态
        int statusOld = record.getStatus();
        
        //更新属性
        record.set("awardTime", awardTime);
    ...
    */
    @Deprecated
    public void setNoChangeAwardTime(final long awardTime) {
        //更新属性
        record.setNoUpdate("awardTime", awardTime);
    }
    /**
     * 是否是机器人
     */
    ...
    */
    @Deprecated
    public void setNoChangeIsRobot(final boolean isRobot) {
        //更新属性
        record.setNoUpdate("isRobot", isRobot ? 1 : 0);
    }
