...
@GofGenFile
public final class InstanceRank extends EntityBase {
    public static final String tableName = "demo_instance_rank";
    ...
    public static final class K {
        ...
        public static final String stars = "stars";    //玩家星星数
    ...
    public InstanceRank(Record record) {
        super(record);
    }
    ...
    */
    @Deprecated
    public void setNoChangeStars(final int stars) {
        //更新属性
        record.setNoUpdate("stars", stars);
    }
    /**
     * 更新排名时间
     */
