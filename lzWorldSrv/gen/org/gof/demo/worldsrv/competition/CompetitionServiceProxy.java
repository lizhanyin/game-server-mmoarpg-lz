...
public final class CompetitionServiceProxy extends ProxyBase {
    ...
    public Object getMethodFunction(Service service, int methodKey) {
        ...
        switch (methodKey) {
            case EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_ADDNEW_HUMAN_COMPETITIONMIRROR_LIST -> {
                return (GofFunction3<Human, CompetitionMirror, List<CompetitionMirror>>) serv::addNew;
            }
            ...
            case EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_UPDATE_LONG_STRING_LIST -> {
                return (GofFunction3<Long, String, List<CompetitionMirror>>) serv::update;
            }
    ...
    public void addNew(Human human, CompetitionMirror humanMirror, List<CompetitionMirror> mirrorList) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_ADDNEW_HUMAN_COMPETITIONMIRROR_LIST,
                new Object[] { human, humanMirror, mirrorList });
    }

    public void getCompetRankNum() {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_GETCOMPETRANKNUM,
                new Object[] {});
    }

    public void getCompeteInfo(long attackerId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_GETCOMPETEINFO_LONG,
                new Object[] { attackerId });
    }

    public void getHumanObjInfo(long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_GETHUMANOBJINFO_LONG,
                new Object[] { humanId });
    }

    public void getHumanRankInfo(long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_GETHUMANRANKINFO_LONG,
                new Object[] { humanId });
    }

    public void getTowerInfo(long humanId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_GETTOWERINFO_LONG,
                new Object[] { humanId });
    }

    public void swapRank(long attackerId, long defenderId, boolean win) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_SWAPRANK_LONG_LONG_BOOLEAN,
                new Object[] { attackerId, defenderId, win });
    }

    public void update(long humanId, String prop, List<CompetitionMirror> mirrorList) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_UPDATE_LONG_STRING_LIST,
                new Object[] { humanId, prop, mirrorList });
    }

    public void updateLevel(HumanObject humanObj) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_COMPETITION_COMPETITIONSERVICE_UPDATELEVEL_HUMANOBJECT,
                new Object[] { humanObj });
    }
}
