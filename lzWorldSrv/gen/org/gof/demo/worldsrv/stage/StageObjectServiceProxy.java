...
public final class StageObjectServiceProxy extends ProxyBase {
    ...
    public void login(long humanId, CallPoint connPoint, long stageId, Vector2D stagePos) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEOBJECTSERVICE_LOGIN_LONG_CALLPOINT_LONG_VECTOR2D,
                new Object[] { humanId, connPoint, stageId, stagePos });
    }

    public void register(HumanObject humanObj) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEOBJECTSERVICE_REGISTER_HUMANOBJECT,
                new Object[] { humanObj });
    }
}
