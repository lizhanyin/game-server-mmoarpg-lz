...
public final class StageServiceProxy extends ProxyBase {
    ...
    public void createStageCommon(int stageSn, int lineNum) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGESERVICE_CREATESTAGECOMMON_INT_INT,
                new Object[] { stageSn, lineNum });
    }

    public void createStageCompetition(HumanObject humanObj, int stageSn, long defenderId) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGESERVICE_CREATESTAGECOMPETITION_HUMANOBJECT_INT_LONG,
                new Object[] { humanObj, stageSn, defenderId });
    }

    public void createStageInstance(int stageSn, int repSn) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGESERVICE_CREATESTAGEINSTANCE_INT_INT,
                new Object[] { stageSn, repSn });
    }

    public void createStageTower(int stageSn, int towerLayer) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGESERVICE_CREATESTAGETOWER_INT_INT,
                new Object[] { stageSn, towerLayer });
    }
