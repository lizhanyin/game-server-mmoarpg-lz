...
public final class StageGlobalServiceProxy extends ProxyBase {
    ...
    public void applyStageBySn(long stageId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_APPLYSTAGEBYSN_LONG,
                new Object[] { stageId });
    }

    public void createCompetition(HumanObject humanObj, int stageSn, long defenderId) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_CREATECOMPETITION_HUMANOBJECT_INT_LONG,
                new Object[] { humanObj, stageSn, defenderId });
    }

    public void createInstance(int stageSn, int instanceSn) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_CREATEINSTANCE_INT_INT,
                new Object[] { stageSn, instanceSn });
    }

    public void createTower(int stageSn, int layerSn) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_CREATETOWER_INT_INT,
                new Object[] { stageSn, layerSn });
    }

    public void destroy(long stageId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_DESTROY_LONG,
                new Object[] { stageId });
    }

    public void infoCancel(long stageId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_INFOCANCEL_LONG,
                new Object[] { stageId });
    }

    public void infoRegister(long stageId, int stageSn, String stageName, String nodeId, String portId) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_INFOREGISTER_LONG_INT_STRING_STRING_STRING,
                new Object[] { stageId, stageSn, stageName, nodeId, portId });
    }

    public void login(long humanId, CallPoint connPoint, List lastStageIds, int firstStory) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_LOGIN_LONG_CALLPOINT_LIST_INT,
                new Object[] { humanId, connPoint, lastStageIds, firstStory });
    }

    public void quitToCommon(HumanObject humanObj, int nowSn, Object... params) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_QUITTOCOMMON_HUMANOBJECT_INT_OBJECTS,
                new Object[] { humanObj, nowSn, params });
    }

    public void stageHumanNumAdd(long stageId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_STAGEHUMANNUMADD_LONG,
                new Object[] { stageId });
    }

    public void stageHumanNumReduce(long stageId) {
        localPort.call(remote, EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_STAGEHUMANNUMREDUCE_LONG,
                new Object[] { stageId });
    }

    public void switchToStage(HumanObject humanObj, long stageTargetId, Vector2D posAppear) {
        localPort.call(remote,
                EnumCall.ORG_GOF_DEMO_WORLDSRV_STAGE_STAGEGLOBALSERVICE_SWITCHTOSTAGE_HUMANOBJECT_LONG_VECTOR2D,
                new Object[] { humanObj, stageTargetId, posAppear });
    }
}
