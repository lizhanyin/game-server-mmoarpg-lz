...
public final class DBServiceProxy extends ProxyBase {
    ...
    public Object getMethodFunction(Service service, int methodKey) {
        ...
        return switch (methodKey) {
            ...
            case EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GET_STRING_LONG,
                    EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GET_STRING_LIST ->
                (GofFunction2<String, Long>) serv::get;
    ...
    public void countBy(boolean flush, String tableName, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_COUNTBY_BOOLEAN_STRING_OBJECTS,
                new Object[] { flush, tableName, params });
    }

    public void countByQuery(boolean flush, String tableName, String whereAndOther, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_COUNTBYQUERY_BOOLEAN_STRING_STRING_OBJECTS,
                new Object[] { flush, tableName, whereAndOther, params });
    }

    public void delete(String tableName, long id) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_DELETE_STRING_LONG,
                new Object[] { tableName, id });
    }

    public void execute(boolean needResult, boolean flushAll, String sql, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_EXECUTE_BOOLEAN_BOOLEAN_STRING_OBJECTS,
                new Object[] { needResult, flushAll, sql, params });
    }
    ...
    public void findBy(boolean flush, int firstResult, int maxResults, String tableName, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_FINDBY_BOOLEAN_INT_INT_STRING_OBJECTS,
                new Object[] { flush, firstResult, maxResults, tableName, params });
    }

    public void findBy(boolean flush, String tableName, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_FINDBY_BOOLEAN_STRING_OBJECTS,
                new Object[] { flush, tableName, params });
    }

    public void findByQuery(boolean flush, String tableName, String whereAndOther, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_FINDBYQUERY_BOOLEAN_STRING_STRING_OBJECTS,
                new Object[] { flush, tableName, whereAndOther, params });
    }

    public void findByQuery(boolean flush, String tableName, List<String> columns, String whereAndOther,
            Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_FINDBYQUERY_BOOLEAN_STRING_LIST_STRING_OBJECTS,
                new Object[] { flush, tableName, columns, whereAndOther, params });
    }
    ...
    public void getBy(boolean flush, String tableName, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GETBY_BOOLEAN_STRING_OBJECTS,
                new Object[] { flush, tableName, params });
    }

    public void getByQuery(boolean flush, String tableName, String whereAndOther, Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GETBYQUERY_BOOLEAN_STRING_STRING_OBJECTS,
                new Object[] { flush, tableName, whereAndOther, params });
    }

    public void getByQuery(boolean flush, String tableName, List<String> columns, String whereAndOther,
            Object... params) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GETBYQUERY_BOOLEAN_STRING_LIST_STRING_OBJECTS,
                new Object[] { flush, tableName, columns, whereAndOther, params });
    }
    ...
    public void update(String tableName, long id, Chunk patch, boolean sync) {
        localPort.call(remote, EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_UPDATE_STRING_LONG_CHUNK_BOOLEAN,
                new Object[] { tableName, id, patch, sync });
    }
}
