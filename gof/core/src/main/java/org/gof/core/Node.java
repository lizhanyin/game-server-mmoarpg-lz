...
public final class Node implements IThreadCase {
    ...
    public Node(String id, String addr) {
        ...
        // 使用构造函数设置 IO 线程数（替代废弃的 setIoThreads 方法）
        this.zmqContext = new ZContext(1);

        // 使用 SocketType 替代废弃的 createSocket(int)
...
//                    }
                ...
                case Call.TYPE_PING -> {
                    ...
                    if(node == null) {
                        ...
                        String remoteAddr = (String) call.methodParam[1];

                        node = addRemoteNode(name, remoteAddr);
                    }
