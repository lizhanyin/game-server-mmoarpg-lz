    ...
    public Object getMethodFunction(Service service, int methodKey) {
        ...
        switch (methodKey) {
            ...
            case EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_FINDBYQUERY_BOOLEAN_STRING_LIST_STRING_OBJECTS -> {
                return (GofFunction5<Boolean, String, List<String>, String, Object[]>)serv::findByQuery;
            }
            ...
            case EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GET_STRING_LIST -> {
                return (GofFunction2<String, List<Long>>)serv::get;
            }
            ...
            case EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_GETBYQUERY_BOOLEAN_STRING_LIST_STRING_OBJECTS -> {
                return (GofFunction5<Boolean, String, List<String>, String, Object[]>)serv::getByQuery;
            }
            case EnumCall.ORG_GOF_CORE_DBSRV_DBSERVICE_INSERT_RECORD -> {
                GofFunction1<Record> f = (record) -> { try { serv.insert(record); } catch(IOException | SQLException e) { throw new org.gof.core.support.SysException(e); } };
                return f;
            }
