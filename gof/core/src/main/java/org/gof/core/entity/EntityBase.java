...
public abstract class EntityBase implements ISerilizable, Comparable<EntityBase> {
    ...
    public boolean equals(Object other) {
        ...
        Class<?> otherClass = castOther.getClass();
        Object thisId = this.getId();
        Object otherId = castOther.getId();
        return new EqualsBuilder().append(thisClass, otherClass).append(thisId, otherId).isEquals();
    }
    ...
    public int hashCode() {
        ...
        Object id = getId();
        return new HashCodeBuilder().append(clazz).append(id).toHashCode();
    }
