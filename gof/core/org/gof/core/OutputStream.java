...
import org.gof.core.support.DistrSerializableException;
...
public class OutputStream {
     ...
     * 以及实现了IDistributedSerializable接口的类
     * 
     * @param call
     * @throws IOException
     */
    public boolean writeCall(Call call) {
        ...
        try {
            write(call);
            return true;
        } catch (DistrSerializableException e) {
            // 失败时还原数据流offset到写入前
    ...
    public void write(Object value) {
        try {
            ...
            throw new StreamOutOfSpaceException(e, "写入数据内容过大，超过了剩余空间：len={}, used={}, value={}", lengthTotal,
                    getLength(), value);
        } catch (IOException e) {
    ...
    private void writeObject(Object value) throws IOException {
        ...
        if (clazz == byte.class || clazz == Byte.class) {
            ...
            for (String array1 : array) {
                stream.writeStringNoTag(array1);
            }
            // ENUM
        ...
        } else if (value instanceof ISerializable seriable) {
            ...
            throw new DistrSerializableException("发现无法被Distributed序列化的类型:{}", clazz.getName());
        }
    }
