...
public @interface Column {
    ...
    // 不同类型字段的长度默认值
    public static final int TYPE_DEFAULT_INT = 11;
    public static final int TYPE_DEFAULT_LONG = 20;
    public static final int TYPE_DEFAULT_STRING = 255;
    public static final int TYPE_DEFAULT_DOUBLE = 0;
