...
public class CallResultAsync extends CallResultBase {
     ...
     * @param context
     */
    public CallResultAsync(long callId, long timeoutDelay,
            /* Object resultObject, */ GofFunction2<Param, Param> resultMethod, Param context) {
    ...
    public CallResultAsync(long callId, long timeoutDelay,
            /* Object resultObject, */ GofFunction3<Boolean, Param, Param> resultMethod, Param context) {
        super(callId, timeoutDelay);
