...
public abstract class EntityBase implements ISerializable, Comparable<EntityBase> {
    // 持久化数据
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(this.getClass(), castOther.getClass()).append(this.getId(), castOther.getId())
                .isEquals();
    }
