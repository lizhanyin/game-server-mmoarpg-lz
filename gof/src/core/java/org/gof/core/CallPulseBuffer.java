...
public class CallPulseBuffer {
    private final int BUFFER_SIZE = 2 * 1024 * 1024;         // 缓冲区5M

    private final String targetNodeId;                       // 目标Node名称
    private final OutputStream buffer = new OutputStream(new byte[BUFFER_SIZE]); // 缓冲
